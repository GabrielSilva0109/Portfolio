        ...
        <>
         ...
         <Container>
            ...
            <Project>
                ...
                <Right>
                    <Top href="https://vertex-tecno.vercel.app/" target='blank'> 
                        <Title >Vertex</Title>
                    </Top>
                    <Subtitle>Pessoal | DashBoard</Subtitle>
                    <Text>
                        Vertex é um projeto pessoal que consiste em um dashboard robusto, e envolvedo todas as partes
                        financeiras como Ações, Cryptomoedas, FIIs, etc. Utilizando diversas APIs como: Binance, NewsAPI,
                        AlphaVantage, Coinmarketcap. O objetivo deste dashboard é fornecer 
                        uma interface amigável e eficiente para gerenciar dados e visualizações."
                    </Text>
                    <Tecs>
                        <Icon src={react}/>
                        <Icon src={typescript}/>
            ...
            <Project>
                ...
                <Right>
                    ...
                    <Text>
                        Clint é um site pessoal para gerenciamento de tarefas no estilo Kanban, onde busquei 
                        treinar minhas habilidades com drag and drop para facilitar a movimentação de tarefas
                         entre colunas. Criado com React e Node.js, este projeto utiliza JavaScript, Bootstrap
                          e MySQL para oferecer uma experiência de usuário intuitiva e eficaz na organização e
